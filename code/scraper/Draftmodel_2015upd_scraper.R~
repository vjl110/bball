...
write.csv(dx.dmp, "data/draftmod/euro.ind_2015upd.csv", row.names = FALSE)
...
write.csv(tm.dmp, "data/draftmod/euro.tm_2015upd.csv", row.names = FALSE)
...
dx.dmp <- dx.dmp[-1,]
dx.dmp[dx.dmp == "&nbsp"] <- NA
	std <- read.csv("scraper/team_stds.csv")
	colnames(std)[3] <- "Tm" 
...
write.csv(ncaa.ind, "data/draftmod/ncaa.ind_2015upd.csv", row.names = FALSE)

###
######  teams ####
###
ref <- as.vector(read.csv("scraper/team_stds.csv")$url)
...
write.csv(team, "data/draftmod/ncaa.tm_2015upd.csv", row.names = FALSE)
