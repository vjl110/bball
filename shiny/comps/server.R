...
#	yrs <- as.numeric(ss$Season[ss$Name == input$nam])
  ...
  sliderValues <- reactive({
    ...
    # Compose data frame 
      ss$diff <- (input$ewp*abs(ss$EWP[ss$Name == input$nam & ss$Season == input$sea] - ss$EWP) + 
		  	input$pts*abs(ss$PTS[ss$Name == input$nam & ss$Season == input$sea] - ss$PTS) + 
			...
			input$attRIM*abs(ss$atRIM[ss$Name == input$nam & ss$Season == input$sea] - ss$atRIM) +			
			input$asd*abs(ss$ASD[ss$Name == input$nam & ss$Season == input$sea] - ss$ASD) +						
			...
			input$trb*abs(ss$TRB[ss$Name == input$nam & ss$Season == input$sea] - ss$TRB) +
			...
			input$reach*abs(ss$Reach[ss$Name == input$nam & ss$Season == input$sea] - ss$Reach) +
			input$wings*abs(ss$Wingspan[ss$Name == input$nam & ss$Season == input$sea] - ss$Wingspan) +
			input$vert*abs(ss$Vertical[ss$Name == input$nam & ss$Season == input$sea] - ss$Vertical) +
			input$sprnt*abs(ss$Sprint[ss$Name == input$nam & ss$Season == input$sea] - ss$Sprint) +
			input$aglty*abs(ss$Agility[ss$Name == input$nam & ss$Season == input$sea] - ss$Agility) +	
			input$age*abs(ss$Age[ss$Name == input$nam & ss$Season == input$sea] - ss$Age) +
			input$mov*abs(ss$MOV[ss$Name == input$nam & ss$Season == input$sea] - ss$MOV) +
			input$sos*abs(ss$SOS[ss$Name == input$nam & ss$Season == input$sea] - ss$SOS))/ (input$ewp+input$pts+input$x2p+input$x2pa+input$x3p+input$x3pa+input$x3bias+input$attRIM+input$asd+input$ft+input$fta+input$ftr+input$x2per+input$x3per+input$ftper+input$efg+input$ts+input$trb+input$ast+input$tov+input$stl+input$blk+input$pfs+input$hgt+input$wgt+input$reach+input$wings+input$vert+input$sprnt+input$aglty+input$age+input$mov+input$sos)
